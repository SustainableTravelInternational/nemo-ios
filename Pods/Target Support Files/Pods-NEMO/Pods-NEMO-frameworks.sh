...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/IQDropDownTextField/IQDropDownTextField.framework"
  install_dsym "${PODS_ROOT}/IQDropDownTextField/IQDropDownTextField.framework.dSYM"
  install_framework "${PODS_ROOT}/IQKeyboardManagerSwift/IQKeyboardManagerSwift.framework"
  install_dsym "${PODS_ROOT}/IQKeyboardManagerSwift/IQKeyboardManagerSwift.framework.dSYM"
  install_framework "${PODS_ROOT}/ObjectMapper/ObjectMapper.framework"
  install_dsym "${PODS_ROOT}/ObjectMapper/ObjectMapper.framework.dSYM"
  install_framework "${PODS_ROOT}/SCLAlertView/SCLAlertView.framework"
  install_dsym "${PODS_ROOT}/SCLAlertView/SCLAlertView.framework.dSYM"
  install_framework "${PODS_ROOT}/SDWebImage/SDWebImage.framework"
  install_dsym "${PODS_ROOT}/SDWebImage/SDWebImage.framework.dSYM"
  install_framework "${PODS_ROOT}/SVProgressHUD/SVProgressHUD.framework"
  install_dsym "${PODS_ROOT}/SVProgressHUD/SVProgressHUD.framework.dSYM"
fi
